...
/**
 * ChatScreen - ANDROID VERSION
 * NO KeyboardAvoidingView - uses native adjustPan
 * Optimized for Android keyboard handling
 * Requires app.json: "softwareKeyboardLayoutMode": "pan"
 */
...
const styles = StyleSheet.create({
  ...
  inputContainer: {
    paddingBottom: 16, // Small spacing for Android system bar
  },
